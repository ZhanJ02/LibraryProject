...
namespace Milliken.LibrarySystem.Services
{
    public class LibraryService : ILibraryService
    {
        ...
        public HashSet<EBook> EBooks { get; set; } = new HashSet<EBook>();
        // Constructor DI
        ...
        public HashSet<EBook> ListEBooks()
        {
        ...
        // Remove Book
        public HashSet<Book> RemoveBooksByTitle(string title)
        {
        ...
        public HashSet<EBook> RemoveEBooksByTitle(string title)
        {
        ...
        public HashSet<Book> AddBooks(string title, string author, int pages, int yearPublished)
        {
        ...
        public HashSet<EBook> AddEBooks(string title, string author, int pages, int yearPublished, double fileSize)
        {
