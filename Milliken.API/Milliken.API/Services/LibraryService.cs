...
namespace Milliken.LibrarySystem.Services
{
    public class LibraryService : ILibraryService
    {
        ...
        public Book AddBooks(string title, string author, int pages, int yearPublished)
        {
        ...
        public Book AddEBooks(string title, string author, int pages, int yearPublished, double fileSize)
        {
        ...
        public List<Book> InitializeBookData()
        {
            // Create Books
        ...
        public List<EBook> InitializeEBookData()
        {
            // Create EBooks
